...
async function getDeezerSong(songName, artistName, accessToken) {
  ...
  // const songUrl = `http://api.deezer.com/search?access_token=${accessToken}&q=artist:${artistName} track:"${songName}"`;
...
// async function getDeezerSong(songName, artistName, accessToken) {
// 	// const songUrl = `http://api.deezer.com/search?dataype=jsonp&q=artist:"${artistName}" track:"${songName}"`;
// 	const songUrl = `http://api.deezer.com/search?q=artist:"${artistName}" track:"${songName}"&output=jsonp&output=jsonp`;
// 	let response;
// 	let id;
...
// async function getDeezerSong(songName, artistName, accessToken) {
// 	const songUrl = `http://api.deezer.com/search?q=artist:"${artistName}" track:"${songName}"`;
// 	let id;
// 	try {
